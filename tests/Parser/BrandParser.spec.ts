...
import {BrandParser} from "../../src/Parser/BrandParser";
...
describe(`The BrandParser extracts the correct records`, () => {
    const parser = new BrandParser();
    ...
    examples.forEach((example) => {
        ...
        const expected = output.persisted.filter((record: IRecord) => record.sk === IGroupType.BRAND);
